...
|---|---|---|---|
| 花王 | 4452 | 化学・日用品 | 35期超（日本最長クラス） |
| リコーリース | 8566 | リース | 30期前後 |
| SPK | 7466 | 自動車部品商社 | 27期前後 |
| 三菱HCキャピタル | 8593 | リース | 26期前後 |
| ユー・エス・エス | 4732 | 中古車オークション | 25期前後 |
| リンナイ | 5947 | 住宅設備（給湯機器） | 24期前後 |
| トランコム | 9058 | 物流情報サービス | 24期前後 |
| 沖縄セルラー電話 | 9436 | 通信（沖縄） | 24期前後 |
| KDDI | 9433 | 通信 | 23期前後 |
| ニトリホールディングス | 9843 | 家具・インテリア小売 | 21期前後 |
...
- **トランコム（9058）**：物流情報サービス（求貨求車のマッチング）を中心とする物流企業。情報プラットフォームとしての側面が強く、独自のポジションを築いています。
...
連続増配株が**過去の実績**で評価する考え方なのに対し、「**累進配当株**」は会社が「**減配しない**」と方針として宣言している銘柄を指します。三菱商事・伊藤忠商事・丸紅などの総合商社や、NTT・三井住友信託などで採用が進んでいます。

- **連続増配株**：実績ベース（過去に毎年増配してきた）
- **累進配当株**：方針ベース（会社が減配しないと公約している）
