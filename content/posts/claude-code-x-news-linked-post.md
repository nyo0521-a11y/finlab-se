...
![読者の入口が検索からSNSへ変わってきたことを示す概念図](/images/x-news-illust-channel-shift.png)
...
![決め打ちの順番で投稿するとトレンドから外れるケースと、話題に合わせて選ぶケースの対比](/images/x-news-illust-rotation-vs-trend.png)
...
![鮮度と多様性のバランスを天秤で示した図：主軸（強めのルール）と重複回避（弱めのルール）](/images/x-news-illust-balance.png)
...
![金利ニュース→住宅ローン・借換えへの関心→関連記事を選ぶ、という3ステップのマッチング図](/images/x-news-illust-news-match.png)
