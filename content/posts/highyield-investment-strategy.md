...
## 買い時の判断：配当利回りで割高・割安を見る

ここまで「何を買うか」を整理してきましたが、実は同じくらい大事なのが「**いつ買うか**」です。

高配当株は、グロース株のように右肩上がりに株価が伸びていくタイプではなく、**成熟企業が中心**です。ビジネスは安定していますが、株価が長期で大きく成長するわけではありません。そのため、株価が割高なタイミングで買ってしまうと、せっかく配当を受け取っても、株価の下落と相殺されてトータルでマイナスになることがあります。

「割高か割安か」を判断するうえで、私が基準にしているのが **配当利回り** です。

```
配当利回り = 1株当たり配当金 ÷ 株価 × 100
```

この式から分かるとおり、株価が下がれば利回りは上がり、株価が上がれば利回りは下がります。つまり**利回り自体が割安・割高の物差しになる**ということです。

### 米国ETFの場合：10年以上の平均利回りと今を比べる

VYM・HDV・SCHD のような長く運用されているETFは、長期の利回り推移データが手に入ります。

- **今の利回りが過去10年以上の平均より高い** → 相対的に割安（買いやすい）
- **今の利回りが平均より明らかに低い** → 割高ゾーン（無理に買いに行かない）

過去の平均と比べる、というシンプルな基準で十分です。私は基本的に積み立てを止めることはしませんが、平均より明らかに利回りが下がっている時期は新規買付を控えめにし、暴落で利回りが平均より大きく上振れた局面で多めに仕込む、というメリハリをつけています。

### 日本の個別株の場合：銘柄ごとの過去平均と比較する

日本株も基本的な考え方は同じです。**個別銘柄ごとに過去数年の平均配当利回りを把握しておき、今の利回りがそれより高いか低いか** で判断します。

「利回りの絶対値が高いから買い」ではなく、「**その銘柄として割安なタイミングか**」を見るのがポイントです。たとえば過去平均が3.5%の銘柄が4%になっていれば割安シグナル、逆に過去平均が4.5%の銘柄が3.8%まで下がっていれば、利回り基準は満たしていても割高サイドと判断します。

### なぜ「利回りで判断する」のが理にかなっているか

PERや株価チャートで割安・割高を見る方法もありますが、高配当株投資の主目的は「配当収入の積み上げ」です。**利回りで判断すれば、自分が買い増したい指標（配当の取り分）の損得を直接見ていることになる** ため、目的との整合性が高くなります。
