...
そこでClaude Codeは、この話題に最も関連する自分の記事として「住宅ローン借り換えシミュレーション」の記事を選び、翌朝のおすすめに設定しました。投稿文の雰囲気としては、次のようなイメージです。
...
![金利ニュース→住宅ローン・借り換えへの関心→関連記事を選ぶ、という3ステップのマッチング図](/images/x-news-illust-news-match.png)
