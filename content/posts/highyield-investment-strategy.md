...
現時点で私が保有しているのは**VYMとHDV**です。HDVは2026年6月の分配頻度変更（四半期→毎月）に伴いNISA成長投資枠の対象外となりましたが（既に保有している分はそのまま非課税で持ち続けられます）、私自身は保有を継続しつつ、今後の追加投資はVYMに寄せる方針です。SCHDはまだ投資できていませんが、将来的に組み入れたい狙いです。
