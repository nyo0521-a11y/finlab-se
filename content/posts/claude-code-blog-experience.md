...
このブログがどうやって生まれたのか、記録として残しておこうと思います。

きっかけは「ツールを作りたい」という一点でした。公開用のブログを用意しようと考えたのは、その少し後のことです。

**Claude Code（Anthropic社のAIコーディング支援ツール）を使い始めたのは、ここから2週間ほど前のこと。** 金融SEとして20年システム開発をしてきたとはいえ、AIコーディングアシスタントはほぼ初体験でした。それでも、ツールを作り、ブログを立ち上げ、記事まで書けてしまった。その体験記です。
