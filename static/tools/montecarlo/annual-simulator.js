...
function renderResults(d) {
  ...
  const html = [
    ...
    "<details class=\"sketch-card\"><summary><span class=\"num\">C</span> シミュレーション統計サマリー<span class=\"chev\">▶</span></summary>",
    "<div class=\"body\"><table class=\"stats-table\"><tr><th>指標</th><th style=\"text-align:right\">値</th></tr>",
    ...
    "<tr><td>資産分布の計算標本</td><td>" + d.percentileSampleSize.toLocaleString() + " 回</td></tr></table></div></details>",
