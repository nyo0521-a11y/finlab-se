...
{{< figure src="/images/scheduled-post-diagram.png" alt="予約投稿の仕組み：dateと現在時刻の関係" caption="frontmatterのdateが現在時刻より未来なら非公開、過去になれば次のビルドで自動的に本番公開される（下図の自動チェック部分は旧仕組みの説明です。後述の内容が最新です）" >}}
